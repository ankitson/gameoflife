...
function $is_Llife_Board$Cell(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Llife_Board$Cell)))
}
function $as_Llife_Board$Cell(obj) {
  return (($is_Llife_Board$Cell(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "life.Board$Cell"))
}
function $isArrayOf_Llife_Board$Cell(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Llife_Board$Cell)))
}
function $asArrayOf_Llife_Board$Cell(obj, depth) {
  return (($isArrayOf_Llife_Board$Cell(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Llife.Board$Cell;", depth))
}
var $d_Llife_Board$Cell = new $TypeData().initClass({
  Llife_Board$Cell: 0
}, true, "life.Board$Cell", {
  Llife_Board$Cell: 1
});
function $s_Llife_Board$Cell$class__toString__Llife_Board$Cell__T($$this) {
  var x = $m_Llife_Board$Live$();
  if ((x === $$this)) {
    return "*"
  } else {
    var x$3 = $m_Llife_Board$Dead$();
    if ((x$3 === $$this)) {
      return "-"
    } else {
...
/** @constructor */
function $c_Llife_Board() {
  $c_O.call(this);
  this.rowsArr$1 = null;
  this.rowsArr2$1 = null;
  this.flag$1 = false;
  this.n$1 = 0;
  this.m$1 = 0;
  this.cacheArr$1 = null
}
$c_Llife_Board.prototype = new $h_O();
$c_Llife_Board.prototype.constructor = $c_Llife_Board;
/** @constructor */
function $h_Llife_Board() {
  /*<skip>*/
}
$h_Llife_Board.prototype = $c_Llife_Board.prototype;
$c_Llife_Board.prototype.neighbours__I__I__AT2 = (function(x, y) {
  if ((this.cacheArr$1.u[x].u[y] === null)) {
    var jsx$2 = this.cacheArr$1.u[x];
    var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_s_Tuple2$mcII$sp().init___I__I((((-1) + x) | 0), (((-1) + y) | 0)), new $c_s_Tuple2$mcII$sp().init___I__I((((-1) + x) | 0), y), new $c_s_Tuple2$mcII$sp().init___I__I((((-1) + x) | 0), ((1 + y) | 0)), new $c_s_Tuple2$mcII$sp().init___I__I(x, (((-1) + y) | 0)), new $c_s_Tuple2$mcII$sp().init___I__I(x, ((1 + y) | 0)), new $c_s_Tuple2$mcII$sp().init___I__I(((1 + x) | 0), (((-1) + y) | 0)), new $c_s_Tuple2$mcII$sp().init___I__I(((1 + x) | 0), y), new $c_s_Tuple2$mcII$sp().init___I__I(((1 + x) | 0), ((1 + y) | 0))]);
    var len = $uI(xs.array$6.length);
    var array = $newArrayObject($d_T2.getArrayOf(), [len]);
    var elem$1 = 0;
    elem$1 = 0;
    ...
    var b = new $c_scm_ArrayBuilder$ofRef().init___s_reflect_ClassTag(new $c_s_reflect_ClassTag$ClassClassTag().init___jl_Class($d_T2.getClassOf()));
    var i = 0;
    ...
    while ((i < len$1)) {
      ...
      if ((x0$1 !== null)) {
        var i$1 = x0$1.$$und1$mcI$sp__I();
        var j = x0$1.$$und2$mcI$sp__I();
        var jsx$1 = ((((i$1 >= 0) && (i$1 < this.n$1)) && (j >= 0)) && (j < this.m$1))
      } else {
        var jsx$1;
    ...
    jsx$2.u[y] = $asArrayOf_T2(b.result__AO(), 1)
  };
  return this.cacheArr$1.u[x].u[y]
});
$c_Llife_Board.prototype.stepCell__I__I__V = (function(x, y) {
  var x1 = this.currentAndPrev__T2();
  if ((x1 !== null)) {
    var board1 = $asArrayOf_Llife_Board$Cell(x1.$$und1__O(), 2);
    var board2 = $asArrayOf_Llife_Board$Cell(x1.$$und2__O(), 2);
    var x$2_$_$$und1$f = board1;
    var x$2_$_$$und2$f = board2
  } else {
    var x$2_$_$$und1$f;
    var x$2_$_$$und2$f;
    throw new $c_s_MatchError().init___O(x1)
  };
  var board1$2 = $asArrayOf_Llife_Board$Cell(x$2_$_$$und1$f, 2);
  var board2$2 = $asArrayOf_Llife_Board$Cell(x$2_$_$$und2$f, 2);
  var cell = board1$2.u[x].u[y];
  var xs = this.neighbours__I__I__AT2(x, y);
  var elem$1 = 0;
  elem$1 = 0;
  var i = 0;
  var len = xs.u.length;
  while ((i < len)) {
    ...
    var x0$2 = $as_T2(arg1);
    if ((x0$2 !== null)) {
      var x$1 = x0$2.$$und1$mcI$sp__I();
      var y$1 = x0$2.$$und2$mcI$sp__I();
      var x$2$1 = board1$2.u[x$1].u[y$1];
      var x$3 = $m_Llife_Board$Live$();
      var jsx$1 = ((x$2$1 !== null) && (x$2$1 === x$3))
    } else {
      var jsx$1;
  ...
  var aliveNbrs = elem$1;
  matchEnd11: {
    var x$3$1 = $m_Llife_Board$Live$();
    if ((x$3$1 === cell)) {
      if ((aliveNbrs < 2)) {
        board2$2.u[x].u[y] = $m_Llife_Board$Dead$();
        break matchEnd11
      }
    };
    var x$5 = $m_Llife_Board$Live$();
    if ((x$5 === cell)) {
      if (((aliveNbrs === 2) || (aliveNbrs === 3))) {
        board2$2.u[x].u[y] = $m_Llife_Board$Live$();
        break matchEnd11
      }
    };
    var x$7 = $m_Llife_Board$Live$();
    if ((x$7 === cell)) {
      if ((aliveNbrs > 3)) {
        board2$2.u[x].u[y] = $m_Llife_Board$Dead$();
        break matchEnd11
...
$c_Llife_Board.prototype.step__V = (function() {
  var end = this.n$1;
  var isEmpty$4 = (end <= 0);
...
$c_Llife_Board.prototype.equals__O__Z = (function(obj) {
  if ($is_Llife_Board(obj)) {
    var x2 = $as_Llife_Board(obj);
    var xs = this.rowsArr$1;
    var this$2 = new $c_scm_ArrayOps$ofRef().init___AO(xs);
    var that = $m_s_Predef$().wrapRefArray__AO__scm_WrappedArray(x2.rowsArr$1);
    if ($s_sc_IndexedSeqOptimized$class__sameElements__sc_IndexedSeqOptimized__sc_GenIterable__Z(this$2, that)) {
      var xs$1 = this.rowsArr2$1;
      var this$4 = new $c_scm_ArrayOps$ofRef().init___AO(xs$1);
      var that$1 = $m_s_Predef$().wrapRefArray__AO__scm_WrappedArray(x2.rowsArr2$1);
      return $s_sc_IndexedSeqOptimized$class__sameElements__sc_IndexedSeqOptimized__sc_GenIterable__Z(this$4, that$1)
    } else {
      return false
    }
  } else {
...
$c_Llife_Board.prototype.rows__AALlife_Board$Cell = (function() {
  return (this.flag$1 ? this.rowsArr$1 : this.rowsArr2$1)
});
$c_Llife_Board.prototype.toString__T = (function() {
  var xs = this.rows__AALlife_Board$Cell();
  var elems$2 = [];
  var i = 0;
  var len = xs.u.length;
  while ((i < len)) {
    var index = i;
    var arg1 = xs.u[index];
    var row = $asArrayOf_Llife_Board$Cell(arg1, 1);
    var b = new $c_scm_StringBuilder().init___();
    var elem$1 = false;
    elem$1 = true;
    b.append__T__scm_StringBuilder("");
    var i$1 = 0;
    var len$1 = row.u.length;
    while ((i$1 < len$1)) {
      var index$1 = i$1;
      var arg1$1 = row.u[index$1];
      if (elem$1) {
...
$c_Llife_Board.prototype.toggle__V = (function() {
  this.flag$1 = (!this.flag$1)
});
$c_Llife_Board.prototype.currentAndPrev__T2 = (function() {
  return (this.flag$1 ? new $c_T2().init___O__O(this.rowsArr$1, this.rowsArr2$1) : new $c_T2().init___O__O(this.rowsArr2$1, this.rowsArr$1))
});
$c_Llife_Board.prototype.init___AALlife_Board$Cell = (function(rowsArr) {
  this.rowsArr$1 = rowsArr;
  var xs = $asArrayOf_O(rowsArr.clone__O(), 1);
  var elems$2 = [];
  var i = 0;
  var len = xs.u.length;
  while ((i < len)) {
    var index = i;
    var arg1 = xs.u[index];
    var x$1 = $asArrayOf_Llife_Board$Cell(arg1, 1);
    var elem = $asArrayOf_Llife_Board$Cell(x$1.clone__O(), 1);
    var unboxedElem = ((elem === null) ? null : elem);
    elems$2.push(unboxedElem);
    i = ((1 + i) | 0)
  };
  this.rowsArr2$1 = $makeNativeArrayWrapper($d_Llife_Board$Cell.getArrayOf().getArrayOf(), elems$2);
  this.flag$1 = true;
  this.n$1 = rowsArr.u.length;
  this.m$1 = rowsArr.u[0].u.length;
  var n1 = this.n$1;
  var n2 = this.m$1;
  var arr = $newArrayObject($d_T2.getArrayOf().getArrayOf().getArrayOf(), [n1]);
  var isEmpty$4 = (n1 <= 0);
  ...
  while ((i$1 !== terminalElement$4)) {
    var v1 = i$1;
    arr.u[v1] = $newArrayObject($d_T2.getArrayOf().getArrayOf(), [n2]);
    count = ((1 + count) | 0);
    i$1 = ((1 + i$1) | 0)
  };
  this.cacheArr$1 = arr;
...
function $is_Llife_Board(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Llife_Board)))
}
function $as_Llife_Board(obj) {
  return (($is_Llife_Board(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "life.Board"))
}
function $isArrayOf_Llife_Board(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Llife_Board)))
}
function $asArrayOf_Llife_Board(obj, depth) {
  return (($isArrayOf_Llife_Board(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Llife.Board;", depth))
}
var $d_Llife_Board = new $TypeData().initClass({
  Llife_Board: 0
}, false, "life.Board", {
  Llife_Board: 1,
  O: 1
});
$c_Llife_Board.prototype.$classData = $d_Llife_Board;
/** @constructor */
function $c_Llife_Board$() {
  $c_O.call(this)
}
...
$h_Llife_Board$.prototype = $c_Llife_Board$.prototype;
$c_Llife_Board$.prototype.init___ = (function() {
  return this
});
$c_Llife_Board$.prototype.randomBoard__I__I__D__Llife_Board = (function(n, m, density) {
  var elems$2 = [];
  var i = 0;
  while ((i < n)) {
    var elem = $m_Llife_Board$().life$Board$$col$1__I__D__ALlife_Board$Cell(m, density);
    var unboxedElem = ((elem === null) ? null : elem);
    elems$2.push(unboxedElem);
    i = ((1 + i) | 0)
  };
  var boardArr = $makeNativeArrayWrapper($d_Llife_Board$Cell.getArrayOf().getArrayOf(), elems$2);
  return new $c_Llife_Board().init___AALlife_Board$Cell(boardArr)
});
$c_Llife_Board$.prototype.life$Board$$col$1__I__D__ALlife_Board$Cell = (function(m$1, density$1) {
  var elems$2 = [];
  var i = 0;
  while ((i < m$1)) {
    var elem = $m_Llife_Board$Dead$();
    elems$2.push(elem);
    i = ((1 + i) | 0)
  };
  var colArr = $makeNativeArrayWrapper($d_Llife_Board$Cell.getArrayOf(), elems$2);
  var isEmpty$4 = (m$1 <= 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : m$1);
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + m$1) | 0));
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  if ((numRangeElements$4 < 0)) {
    $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(0, m$1, 1, false)
  };
  var i$1 = 0;
  var count = 0;
  while ((i$1 !== terminalElement$4)) {
    ...
    if ((this$8.self$1.nextFloat__F() <= density$1)) {
      colArr.u[v1] = $m_Llife_Board$Live$()
    };
    count = ((1 + count) | 0);
    i$1 = ((1 + i$1) | 0)
  };
...
$c_Llife_Board$.prototype.$classData = $d_Llife_Board$;
var $n_Llife_Board$ = (void 0);
function $m_Llife_Board$() {
  if ((!$n_Llife_Board$)) {
    $n_Llife_Board$ = new $c_Llife_Board$().init___()
  };
  return $n_Llife_Board$
}
/** @constructor */
...
$c_Llife_GameOfLifeJS$.prototype = new $h_O();
$c_Llife_GameOfLifeJS$.prototype.constructor = $c_Llife_GameOfLifeJS$;
/** @constructor */
function $h_Llife_GameOfLifeJS$() {
  /*<skip>*/
}
$h_Llife_GameOfLifeJS$.prototype = $c_Llife_GameOfLifeJS$.prototype;
$c_Llife_GameOfLifeJS$.prototype.init___ = (function() {
  $n_Llife_GameOfLifeJS$ = this;
  this.run$1 = true;
  this.board$1 = $m_Llife_Board$().randomBoard__I__I__D__Llife_Board(10, 10, 0.1);
  this.canvas$1 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("life");
  this.canvas$1.width = $doubleToInt($uD(this.canvas$1.offsetWidth));
  this.canvas$1.height = $doubleToInt($uD(this.canvas$1.offsetHeight));
  this.ctx$1 = this.canvas$1.getContext("2d");
  this.cellWidth$1 = (($uI(this.canvas$1.width) / this.board$1.m$1) | 0);
  this.cellHeight$1 = (($uI(this.canvas$1.height) / this.board$1.n$1) | 0);
  this.stats$1 = new $g.Stats();
  this.stats$1.showPanel(1);
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body.appendChild(this.stats$1.dom);
  return this
});
$c_Llife_GameOfLifeJS$.prototype.init__V = (function() {
  this.cellWidth$1 = (($uI(this.canvas$1.width) / this.board$1.m$1) | 0);
  this.cellHeight$1 = (($uI(this.canvas$1.height) / this.board$1.n$1) | 0);
  var jsx$1 = this.ctx$1;
  var s = $m_Lorg_scalajs_dom_ext_Color$().Black$1.toString__T();
  jsx$1.strokeStyle = s;
  this.ctx$1.lineWidth = 1.0;
  this.ctx$1.moveTo(0.0, 0.0);
  this.ctx$1.clearRect(0.0, 0.0, $uI(this.canvas$1.width), $uI(this.canvas$1.height))
});
$c_Llife_GameOfLifeJS$.prototype.main__V = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("hello from scalajs\n");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().onclick = (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Llife_GameOfLifeJS$$anonfun$main$2().init___());
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().onkeydown = (function(f$1) {
    return (function(arg1$1) {
      return f$1.apply__O__O(arg1$1)
    })
  })(new $c_Llife_GameOfLifeJS$$anonfun$main$3().init___());
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("size").onkeypress = (function(f$2) {
    return (function(arg1$2) {
      return f$2.apply__O__O(arg1$2)
    })
  })(new $c_Llife_GameOfLifeJS$$anonfun$main$4().init___());
  this.init__V();
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().requestAnimationFrame((function(x$6$2) {
    $uD(x$6$2);
    $m_Llife_GameOfLifeJS$().draw__V()
  }))
});
$c_Llife_GameOfLifeJS$.prototype.draw__V = (function() {
  this.stats$1.begin();
  var x1 = this.board$1.currentAndPrev__T2();
  if ((x1 !== null)) {
    var boardArr = $asArrayOf_Llife_Board$Cell(x1.$$und1__O(), 2);
    var boardArr2 = $asArrayOf_Llife_Board$Cell(x1.$$und2__O(), 2);
    var x$1_$_$$und1$f = boardArr;
    var x$1_$_$$und2$f = boardArr2
  } else {
    var x$1_$_$$und1$f;
    var x$1_$_$$und2$f;
    throw new $c_s_MatchError().init___O(x1)
  };
  var boardArr$2 = $asArrayOf_Llife_Board$Cell(x$1_$_$$und1$f, 2);
  var boardArr2$2 = $asArrayOf_Llife_Board$Cell(x$1_$_$$und2$f, 2);
  var end = this.board$1.m$1;
  var isEmpty$4 = (end <= 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : end);
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + end) | 0));
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  ...
  while ((i !== terminalElement$4)) {
    var row = i;
    var end$1 = $m_Llife_GameOfLifeJS$().board$1.n$1;
    var isEmpty$4$1 = (end$1 <= 0);
    var numRangeElements$4$1 = (isEmpty$4$1 ? 0 : end$1);
    var lastElement$4$1 = (isEmpty$4$1 ? (-1) : (((-1) + end$1) | 0));
    var terminalElement$4$1 = ((1 + lastElement$4$1) | 0);
    ...
    while ((i$1 !== terminalElement$4$1)) {
      var v1 = i$1;
      var xcoord = $imul(v1, $m_Llife_GameOfLifeJS$().cellWidth$1);
      var ycoord = $imul(row, $m_Llife_GameOfLifeJS$().cellHeight$1);
      var x = boardArr$2.u[row].u[v1];
      var x$2 = boardArr2$2.u[row].u[v1];
      if ((!(x === x$2))) {
        var x$3 = boardArr$2.u[row].u[v1];
        var x$4 = $m_Llife_Board$Live$();
        if (((x$3 !== null) && (x$3 === x$4))) {
          $m_Llife_GameOfLifeJS$().ctx$1.fillStyle = "rgba(255,0,0,1)"
        } else {
          $m_Llife_GameOfLifeJS$().ctx$1.fillStyle = "rgba(255,255,255,1)"
        };
        var width = $m_Llife_GameOfLifeJS$().cellWidth$1;
        var height = $m_Llife_GameOfLifeJS$().cellHeight$1;
        $m_Llife_GameOfLifeJS$().ctx$1.fillRect(xcoord, ycoord, width, height)
      };
      count$1 = ((1 + count$1) | 0);
      i$1 = ((1 + i$1) | 0)
    };
  ...
  this.board$1.step__V();
  this.stats$1.end();
  if (this.run$1) {
    $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().requestAnimationFrame((function(x$2$2) {
      $uD(x$2$2);
      $m_Llife_GameOfLifeJS$().draw__V()
    }))
  }
});
$c_Llife_GameOfLifeJS$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Llife_GameOfLifeJS$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Llife_GameOfLifeJS$ = new $TypeData().initClass({
  Llife_GameOfLifeJS$: 0
}, false, "life.GameOfLifeJS$", {
  Llife_GameOfLifeJS$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Llife_GameOfLifeJS$.prototype.$classData = $d_Llife_GameOfLifeJS$;
var $n_Llife_GameOfLifeJS$ = (void 0);
function $m_Llife_GameOfLifeJS$() {
  if ((!$n_Llife_GameOfLifeJS$)) {
    $n_Llife_GameOfLifeJS$ = new $c_Llife_GameOfLifeJS$().init___()
  };
  return $n_Llife_GameOfLifeJS$
}
$e.life = ($e.life || {});
$e.life.GameOfLifeJS = $m_Llife_GameOfLifeJS$;
/** @constructor */
...
$c_Lorg_scalajs_dom_ext_Color$.prototype.init___ = (function() {
  ...
  var this$5 = new $c_sci_StringOps().init___T(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["#(", ")(", ")(", ")"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.d$1, this.d$1, this.d$1])));
  ...
  var this$8 = new $c_sci_StringOps().init___T(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["#(", "", ")(", "", ")(", "", ")"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.d$1, this.d$1, this.d$1, this.d$1, this.d$1, this.d$1])));
  ...
  this.all$1 = $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.White$1, this.Red$1, this.Green$1, this.Blue$1, this.Cyan$1, this.Magenta$1, this.Yellow$1, this.Black$1])));
  return this
});
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Llife_GameOfLifeJS$$anonfun$main$2() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Llife_GameOfLifeJS$$anonfun$main$2.prototype = new $h_sr_AbstractFunction1();
$c_Llife_GameOfLifeJS$$anonfun$main$2.prototype.constructor = $c_Llife_GameOfLifeJS$$anonfun$main$2;
/** @constructor */
function $h_Llife_GameOfLifeJS$$anonfun$main$2() {
  /*<skip>*/
}
$h_Llife_GameOfLifeJS$$anonfun$main$2.prototype = $c_Llife_GameOfLifeJS$$anonfun$main$2.prototype;
$c_Llife_GameOfLifeJS$$anonfun$main$2.prototype.init___ = (function() {
  return this
});
$c_Llife_GameOfLifeJS$$anonfun$main$2.prototype.apply__O__O = (function(v1) {
  return this.apply__Lorg_scalajs_dom_raw_MouseEvent__O(v1)
});
$c_Llife_GameOfLifeJS$$anonfun$main$2.prototype.apply__Lorg_scalajs_dom_raw_MouseEvent__O = (function(evt) {
  $m_Llife_GameOfLifeJS$().run$1 = (!$m_Llife_GameOfLifeJS$().run$1);
  return ($m_Llife_GameOfLifeJS$().run$1 ? ($m_Llife_GameOfLifeJS$().init__V(), $uI($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().requestAnimationFrame((function(x$3$2) {
    $uD(x$3$2);
    $m_Llife_GameOfLifeJS$().draw__V()
  })))) : (void 0))
});
var $d_Llife_GameOfLifeJS$$anonfun$main$2 = new $TypeData().initClass({
  Llife_GameOfLifeJS$$anonfun$main$2: 0
}, false, "life.GameOfLifeJS$$anonfun$main$2", {
  Llife_GameOfLifeJS$$anonfun$main$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Llife_GameOfLifeJS$$anonfun$main$2.prototype.$classData = $d_Llife_GameOfLifeJS$$anonfun$main$2;
/** @constructor */
function $c_Llife_GameOfLifeJS$$anonfun$main$3() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Llife_GameOfLifeJS$$anonfun$main$3.prototype = new $h_sr_AbstractFunction1();
$c_Llife_GameOfLifeJS$$anonfun$main$3.prototype.constructor = $c_Llife_GameOfLifeJS$$anonfun$main$3;
/** @constructor */
function $h_Llife_GameOfLifeJS$$anonfun$main$3() {
  /*<skip>*/
}
$h_Llife_GameOfLifeJS$$anonfun$main$3.prototype = $c_Llife_GameOfLifeJS$$anonfun$main$3.prototype;
$c_Llife_GameOfLifeJS$$anonfun$main$3.prototype.init___ = (function() {
  return this
});
$c_Llife_GameOfLifeJS$$anonfun$main$3.prototype.apply__O__O = (function(v1) {
  return this.apply__Lorg_scalajs_dom_raw_KeyboardEvent__O(v1)
});
$c_Llife_GameOfLifeJS$$anonfun$main$3.prototype.apply__Lorg_scalajs_dom_raw_KeyboardEvent__O = (function(event) {
  if (($uI(event.keyCode) === 39)) {
    $m_Llife_GameOfLifeJS$().draw__V()
  };
  if (($uI(event.keyCode) === 32)) {
    $m_Llife_GameOfLifeJS$().run$1 = (!$m_Llife_GameOfLifeJS$().run$1)
  };
  return ($m_Llife_GameOfLifeJS$().run$1 ? ($m_Llife_GameOfLifeJS$().init__V(), $uI($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().requestAnimationFrame((function(x$4$2) {
    $uD(x$4$2);
    $m_Llife_GameOfLifeJS$().draw__V()
  })))) : (void 0))
});
var $d_Llife_GameOfLifeJS$$anonfun$main$3 = new $TypeData().initClass({
  Llife_GameOfLifeJS$$anonfun$main$3: 0
}, false, "life.GameOfLifeJS$$anonfun$main$3", {
  Llife_GameOfLifeJS$$anonfun$main$3: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Llife_GameOfLifeJS$$anonfun$main$3.prototype.$classData = $d_Llife_GameOfLifeJS$$anonfun$main$3;
/** @constructor */
function $c_Llife_GameOfLifeJS$$anonfun$main$4() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Llife_GameOfLifeJS$$anonfun$main$4.prototype = new $h_sr_AbstractFunction1();
$c_Llife_GameOfLifeJS$$anonfun$main$4.prototype.constructor = $c_Llife_GameOfLifeJS$$anonfun$main$4;
/** @constructor */
function $h_Llife_GameOfLifeJS$$anonfun$main$4() {
  /*<skip>*/
}
$h_Llife_GameOfLifeJS$$anonfun$main$4.prototype = $c_Llife_GameOfLifeJS$$anonfun$main$4.prototype;
$c_Llife_GameOfLifeJS$$anonfun$main$4.prototype.init___ = (function() {
  return this
});
$c_Llife_GameOfLifeJS$$anonfun$main$4.prototype.apply__O__O = (function(v1) {
  return this.apply__Lorg_scalajs_dom_raw_KeyboardEvent__O(v1)
});
$c_Llife_GameOfLifeJS$$anonfun$main$4.prototype.apply__Lorg_scalajs_dom_raw_KeyboardEvent__O = (function(evt) {
  $m_Llife_GameOfLifeJS$().run$1 = false;
  try {
    var this$2 = new $c_sci_StringOps().init___T($as_T($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("size").value));
    var this$4 = $m_jl_Integer$();
    var s = this$2.repr$1;
    var newSize = this$4.parseInt__T__I__I(s, 10);
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("sizeShow").innerHTML = ("" + newSize);
    $m_Llife_GameOfLifeJS$().board$1 = $m_Llife_Board$().randomBoard__I__I__D__Llife_Board(newSize, newSize, 0.1);
    $m_Llife_GameOfLifeJS$().run$1 = true;
    $m_Llife_GameOfLifeJS$().init__V();
    return $uI($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().requestAnimationFrame((function(x$5$2) {
      $uD(x$5$2);
      $m_Llife_GameOfLifeJS$().draw__V()
    })))
  } catch (e) {
...
var $d_Llife_GameOfLifeJS$$anonfun$main$4 = new $TypeData().initClass({
  Llife_GameOfLifeJS$$anonfun$main$4: 0
}, false, "life.GameOfLifeJS$$anonfun$main$4", {
  Llife_GameOfLifeJS$$anonfun$main$4: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Llife_GameOfLifeJS$$anonfun$main$4.prototype.$classData = $d_Llife_GameOfLifeJS$$anonfun$main$4;
/** @constructor */
function $c_Lorg_scalajs_dom_ext_Color() {
  $c_O.call(this);
  this.r$1 = 0;
...
/** @constructor */
function $c_Llife_Board$Dead$() {
  $c_O.call(this)
}
$c_Llife_Board$Dead$.prototype = new $h_O();
$c_Llife_Board$Dead$.prototype.constructor = $c_Llife_Board$Dead$;
/** @constructor */
function $h_Llife_Board$Dead$() {
  /*<skip>*/
}
$h_Llife_Board$Dead$.prototype = $c_Llife_Board$Dead$.prototype;
$c_Llife_Board$Dead$.prototype.init___ = (function() {
  return this
});
$c_Llife_Board$Dead$.prototype.productPrefix__T = (function() {
  return "Dead"
});
$c_Llife_Board$Dead$.prototype.productArity__I = (function() {
  return 0
});
$c_Llife_Board$Dead$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Llife_Board$Dead$.prototype.toString__T = (function() {
  return $s_Llife_Board$Cell$class__toString__Llife_Board$Cell__T(this)
});
$c_Llife_Board$Dead$.prototype.hashCode__I = (function() {
  return 2125956
});
$c_Llife_Board$Dead$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Llife_Board$Dead$ = new $TypeData().initClass({
  Llife_Board$Dead$: 0
}, false, "life.Board$Dead$", {
  Llife_Board$Dead$: 1,
  O: 1,
  Llife_Board$Cell: 1,
  s_Product: 1,
...
$c_Llife_Board$Dead$.prototype.$classData = $d_Llife_Board$Dead$;
var $n_Llife_Board$Dead$ = (void 0);
function $m_Llife_Board$Dead$() {
  if ((!$n_Llife_Board$Dead$)) {
    $n_Llife_Board$Dead$ = new $c_Llife_Board$Dead$().init___()
  };
  return $n_Llife_Board$Dead$
}
/** @constructor */
function $c_Llife_Board$Live$() {
  $c_O.call(this)
}
$c_Llife_Board$Live$.prototype = new $h_O();
$c_Llife_Board$Live$.prototype.constructor = $c_Llife_Board$Live$;
/** @constructor */
function $h_Llife_Board$Live$() {
  /*<skip>*/
}
$h_Llife_Board$Live$.prototype = $c_Llife_Board$Live$.prototype;
$c_Llife_Board$Live$.prototype.init___ = (function() {
  return this
});
$c_Llife_Board$Live$.prototype.productPrefix__T = (function() {
  return "Live"
});
$c_Llife_Board$Live$.prototype.productArity__I = (function() {
  return 0
});
$c_Llife_Board$Live$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Llife_Board$Live$.prototype.toString__T = (function() {
  return $s_Llife_Board$Cell$class__toString__Llife_Board$Cell__T(this)
});
$c_Llife_Board$Live$.prototype.hashCode__I = (function() {
  return 2368780
});
$c_Llife_Board$Live$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Llife_Board$Live$ = new $TypeData().initClass({
  Llife_Board$Live$: 0
}, false, "life.Board$Live$", {
  Llife_Board$Live$: 1,
  O: 1,
  Llife_Board$Cell: 1,
  s_Product: 1,
...
$c_Llife_Board$Live$.prototype.$classData = $d_Llife_Board$Live$;
var $n_Llife_Board$Live$ = (void 0);
function $m_Llife_Board$Live$() {
  if ((!$n_Llife_Board$Live$)) {
    $n_Llife_Board$Live$ = new $c_Llife_Board$Live$().init___()
  };
  return $n_Llife_Board$Live$
}
/** @constructor */
function $c_T2() {
  $c_O.call(this);
...
//# sourceMappingURL=life-fastopt.js.map
